      ...
      <aside className="w-64 border-r border-zinc-800 bg-zinc-950 p-4 flex flex-col">
        <div className="p-6 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="bg-red-600 text-white font-black px-2 py-1 rounded shadow-lg shadow-red-900/40 transform -rotate-3">
              CW
            </div>
            {/* Текст білим */}
            <h2 className="text-xl font-bold tracking-tight text-white">
              Admin <span className="text-zinc-500 font-light text-sm uppercase ml-1 tracking-widest">Panel</span>
            </h2>
          </div>
