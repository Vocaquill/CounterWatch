...
export function MovieCard({ movie, onClick, compact = false }: { movie: any, onClick: () => void, compact?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={() => navigate(`/movie/101`)}
        className="relative aspect-[2/3] bg-zinc-900 rounded-[2rem] overflow-hidden border border-white/5 transition-all duration-500 group-hover:border-red-600 group-hover:shadow-[0_0_40px_rgba(220,38,38,0.25)]">
        <img
          src={movie.image}
          alt={movie.title}
